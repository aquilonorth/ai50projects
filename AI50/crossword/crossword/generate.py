...
class CrosswordCreator():
    ...
    def enforce_node_consistency(self):
        """
        Update `self.domains` such that each variable is node-consistent. Remove any values that are inconsistent with a variable's unary
    ...
    def select_unassigned_variable(self, assignment):
        ...
        # Sort by MRV, then by degree (descending)
